...
```{r, dpi=500, echo=FALSE, fig.cap="Various order statistics for rolls of 5 standard dice. Frequencies were calculated using 100,000 simulations."}
...
df %>%
  ggplot(aes(x = value)) +
  geom_bar(width = 0.2, fill = "gray", color = "black") +
